"""
Django settings for TrainsService project.
...
SECRET_KEY = 'django-insecure-odmm+juh@hw6)exx&yi&s3l(#guq(y+@*34o1pt=*y%azcpt)&'
...
ROOT_URLCONF = 'TrainsService.urls'
...
WSGI_APPLICATION = 'TrainsService.wsgi.application'
...
GRAPHENE = {
    'SCHEMA': 'FlightsService.schema.schema',
}
